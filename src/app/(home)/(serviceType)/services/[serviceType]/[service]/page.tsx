...
import { useAddToCartMutation } from '../../../../../../redux/app/cart/cartApi'
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">{contextHolder}
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                <span className="mr-3">Service Item list</span>
                                <Space size={[0, 8]} wrap >
                                    {service.serviceItem.map(s => <Tag bordered={false}>{s}</Tag>)}
                                </Space>
                            </div>

                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                <span className="mr-3">Service Zone</span>
                                <div className="relative">

                                    <div>
                                        <Space size={[0, 8]} wrap>
                                            {service.serviceArea.map(s => <Tag>{s}</Tag>)}
                                        </Space>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900">{service.price} <span className='font-light '>BDT</span></span>
                                <button onClick={actionToCart} className=" text-sm flex ml-auto text-white active:bg-red-700 bg-red-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded">Add to Cart</button>
