...
export default function AllShippingAddress() {
    ...
    return (
        <div className=''>
            <h2 className="uppercase tracking-wide text-lg font-semibold text-gray-700 flex justify-between my-2">My Shipping Addresses <span className='text-xs hover:text-blue-700 cursor-pointer'>Edit <EditOutlined /></span></h2>
